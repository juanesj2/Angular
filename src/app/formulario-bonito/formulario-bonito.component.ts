...
@Component({
  selector: 'app-formulario-bonito',
  imports: [RouterOutlet, FormsModule],
  templateUrl: './formulario-bonito.component.html',
  styleUrl: './formulario-bonito.component.css'
})
export class FormularioBonitoComponent {
  art = {
    codigo: 0,
    descripcion: "",
    precio: 0
